...
class UNET(nn.Module):
    def __init__(self):
        ...
        self.deconvblock1 = deconv2dBlock([256 , 256 , 512])
        self.deconvblock2 = deconv2dBlock([256 + 512 , 256 , 256])
        self.deconvblock3 = deconv2dBlock([128 + 256 , 128 , 128])

        self.convblock4 = conv2dBlock([64 + 128 , 64 , 64])
    ...
    def forward(self , x) :
        ...
        deconv_out1 = self.deconvblock1(downsampled3)
        deconv_out2 = self.deconvblock2(torch.cat((conv_out3 ,deconv_out1) , dim = 1 ))

        deconv_out3 = self.deconvblock3(torch.cat((conv_out2 ,deconv_out2) , dim = 1))
        _ , conv_out = self.convblock4(torch.cat((conv_out1 , deconv_out3 ) , dim = 1))
